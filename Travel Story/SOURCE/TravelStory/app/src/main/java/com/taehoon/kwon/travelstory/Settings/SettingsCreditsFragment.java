...
public class SettingsCreditsFragment extends SettingsContainerFragment implements OnBackPressed {

    public static final String FRAG_TAG = "settings_credits";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragment_settings_credits, container, false);
